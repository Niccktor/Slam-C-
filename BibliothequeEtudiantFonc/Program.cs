...
namespace Bibliotheque
{
    class Program
    {
            ...
            do
            {
                ...
                switch (choix)
                {
                    ...
                    case 3:
                        ...
                        Console.Clear();
                        AffichageColectionLivres(collectionLivres);
                        Console.ReadKey();
                        break;
                    ...
                    case 5:
                        ...
                        AffichageColectionAdherent(collectionAdherents);
                    ...
                    case 8:
                        ...
                        Console.Clear();
                        AffichageCollectionEmprunts(collectionEmprunts);
                        break;
        ...
        private static void AffichageColectionLivres (List<Livre> collectionLivres)
        {
            if (collectionLivres.Count == 0)
            {
                textMillieu("------------------------------------------------------------------------");
        ...
        private static void AffichageColectionAdherent(List<Adherent> collectionAdherents)
        {
            if (collectionAdherents.Count == 0)
            {
                textMillieu("------------------------------------------------------------------------");
        ...
        private static void AffichageCollectionEmprunts (List<Emprunt> CollectionEmprunts)
        {
